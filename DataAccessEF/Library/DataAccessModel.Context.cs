...
namespace Library
{
    ...
    public partial class AdventureWorks2008Entities : DbContext
    {
        ...
        [DbFunction("AdventureWorks2008Entities", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorks2008Entities].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
        ...
        public virtual ObjectResult<uspGetManagerEmployees_Result> RetrieveManagerEmployees(Nullable<int> businessEntityID)
        {
            var businessEntityIDParameter = businessEntityID.HasValue ?
                new ObjectParameter("BusinessEntityID", businessEntityID) :
                new ObjectParameter("BusinessEntityID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspGetManagerEmployees_Result>("RetrieveManagerEmployees", businessEntityIDParameter);
        }
    }
}
